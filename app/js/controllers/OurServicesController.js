  ...
  $scope.packages = [
    {
      ...
      detailone: '- Birthday cake $40 (standard cake is for 10 servings - 6 inch. If theme cake is requested, price will be recalculated).',
      detailtwo: '- 12 Cupcakes in a box $25 (Choice of Vanilla, Red Velvet or Chocolate)',
    ...
    },
    {
      ...
      detailone: '- Anniversary cake $50 (standard cake is for 10 servings - 6 inch. If theme cake is requested, price will be recalculated).',
      detailtwo: '- 12 Cupcakes in a box $30 (Choice of Vanilla, Red Velvet, Chocolate, Double Chocolate Mint, Lemon with vanilla buttercream, Vanilla-Raspberry with white chocolate buttercream, or Blueberry Lemon ).',
      detailthree: '- Flower prices upon request.',
      detailfour: '- Congratuliation Card.',
      detailfive: '- Wine and fruit basket.',
      detailsix: '- Balloons are included.'
    },
    {
      ...
      detailtwo: '- 12 Cupcakes in a box $40 (Choice of Vanilla, Red Velvet, Chocolate, Double Chocolate Mint, Lemon with vanilla buttercream, Vanilla-Raspberry with white chocolate buttercream, or Blueberry Lemon with wedding theme decoration).',
      detailthree: '- Flower prices upon request (Fresh flowers and ribbon decoration for both the 6” cake and the cupcake stand).',
      detailfour: '- Edible wedding flower on each cupcake. ',
      detailsix: '- Cupcake stand.',
      detailseven: '- Congratuliation Card.',
